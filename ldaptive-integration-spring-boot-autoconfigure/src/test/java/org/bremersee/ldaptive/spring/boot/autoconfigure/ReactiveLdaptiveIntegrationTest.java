...
@SpringBootTest(
    ...
    properties = {
        ...
        "bremersee.ldaptive.authentication.config.user-object-class=inetOrgPerson",
        "bremersee.ldaptive.authentication.config.username-attribute=uid",
        "bremersee.ldaptive.authentication.config.real-name-attribute=uid",
        "bremersee.ldaptive.authentication.config.member-attribute=memberOf",
        "bremersee.ldaptive.authentication.config.password-attribute=",
        "bremersee.ldaptive.authentication.config.group-base-dn=ou=groups,dc=bremersee,dc=org",
        "bremersee.ldaptive.authentication.config.group-object-class=groupOfUniqueNames",
        "bremersee.ldaptive.authentication.config.group-id-attribute=cn",
        "bremersee.ldaptive.authentication.config.group-member-attribute=uniqueMember",
    })
