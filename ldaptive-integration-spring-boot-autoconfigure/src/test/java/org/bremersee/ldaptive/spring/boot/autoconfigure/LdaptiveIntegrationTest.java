...
@SpringBootTest(
    ...
    properties = {
        ...
        "bremersee.ldaptive.connection.ldap-url=ldap://localhost:${spring.ldap.embedded.port}",
        "bremersee.ldaptive.connection.use-start-tls=false",
        "bremersee.ldaptive.connection.bind-dn=uid=admin",
        "bremersee.ldaptive.connection.bind-credentials=secret",
        "bremersee.ldaptive.connection.pooled=false",
        ...
        "bremersee.ldaptive.authentication.group-to-role-mapping[0].group-name=managers",
        "bremersee.ldaptive.authentication.group-to-role-mapping[0].role-name=admins",
    })
